...
namespace Lab07_Levchenko
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            InitializeComponent();
            cbKeySize.Text = "128";
            comboBox2.Text = "PBCS7";
            toolTipSave.SetToolTip(buttonSave, "Зберегти");
            toolTipLoad.SetToolTip(buttonLoad, "Завантажити");
            toolTipGenBi.SetToolTip(buttonGIV, "Згенерувати BI");
            toolTipGenKey.SetToolTip(buttonGKey, "Згенерувати ключ");
        }
        ...
        private void buttonGKey_Click(object sender, EventArgs e)
        {
        ...
        private void buttonGIV_Click(object sender, EventArgs e)
        {
            myAes.GenerateIV();
            aesIV = myAes.IV;
